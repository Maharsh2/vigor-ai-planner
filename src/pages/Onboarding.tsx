...
const goalOptions = [
  { value: "bulk", label: "Building Muscle (Bulk) " },
  { value: "cut", label: "Lose Fat (Cut) " },
  { value: "recomp", label: "Body Recompostion" },
  { value: "strength", label: "Build Strength" },
  { value: "endurace", label: "Improve Endurace" },
];

const experienceOptions = [
  { value: "beginner", label: "Beginner (0-1 years)" },
  { value: "intermediate", label: "Intermediate (1-3 years)" },
  { value: "advance", label: "Advanced (3+ years)" },
];
        ...
        <div className="max-w-xl mx-auto">
          ...
          {!isGenerating ? (
            <Card className="border p-6">
              ...
              <form onSubmit={handleQuestionnaire} className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <Button
                    type="submit"
                    className="flex-1 gap-2 bg-(--color-accent) text-(--color-background)"
                  >
            ...
            <Card className="border text-center py-16">
              ...
              <p className="text-(--color-muted)">{" "}Our AI is building personalized training program....</p>
            </Card>
          )}
        </div>
      </div>
